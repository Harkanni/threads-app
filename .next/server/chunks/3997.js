...
function ClerkContextProvider(props) {
  ...
  return (
    // @ts-expect-error
    /* @__PURE__ */ react_experimental_default().createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ react_experimental_default().createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ react_experimental_default().createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ react_experimental_default().createElement(OrganizationContext.Provider, { value: organizationCtx }, /* @__PURE__ */ react_experimental_default().createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ react_experimental_default().createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
...
var useIsomorphicLayoutEffect = IS_SERVER ? react_experimental_.useEffect : react_experimental_.useLayoutEffect;
...
var SWRConfigContext = (0,react_experimental_.createContext)({});
var SWRConfig$1 = function (props) {
    var value = props.value;
    // Extend parent context values and middleware.
    var extendedConfig = mergeConfigs((0,react_experimental_.useContext)(SWRConfigContext), value);
    // Should not use the inherited provider.
    var provider = value && value.provider;
    // Use a lazy initialized state to create the cache on first access.
    var cacheContext = (0,react_experimental_.useState)(function () {
        return provider
...
var useStateWithDeps = function (state, unmountedRef) {
    var rerender = (0,react_experimental_.useState)({})[1];
    var stateRef = (0,react_experimental_.useRef)(state);
    // If a state property (data, error or isValidating) is accessed by the render
    // function, we mark the property as a dependency so if it is updated again
    // in the future, we trigger a rerender.
    // This is also known as dependency-tracking.
    var stateDependenciesRef = (0,react_experimental_.useRef)({
        data: false,
        error: false,
        isValidating: false
    });
     ...
     * ```
     */
    var setState = (0,react_experimental_.useCallback)(function (payload) {
...
var useSWRHandler = function (_key, fetcher, config) {
    ...
    var initialMountedRef = (0,react_experimental_.useRef)(false);
    // If the hook is unmounted already. This will be used to prevent some effects
    // to be called after unmounting.
    var unmountedRef = (0,react_experimental_.useRef)(false);
    // Refs to keep the key and config.
    var keyRef = (0,react_experimental_.useRef)(key);
    var fetcherRef = (0,react_experimental_.useRef)(fetcher);
    var configRef = (0,react_experimental_.useRef)(config);
    ...
    var revalidate = (0,react_experimental_.useCallback)(function (revalidateOpts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    var boundMutate = (0,react_experimental_.useCallback)(
    ...
    (0,react_experimental_.useDebugValue)(data);
...
/* harmony export */ });
/* harmony import */ var _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64470);
"use client";
