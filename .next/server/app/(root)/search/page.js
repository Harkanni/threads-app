...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77603)), "C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\search\\page.tsx"],
...
const pages = ["C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\search\\page.tsx"];
...
;// CONCATENATED MODULE: ./components/cards/UserCard.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\Owner\Desktop\React Folder\threads\components\cards\UserCard.tsx`)
...
/* harmony default export */ const UserCard = (__default__);
;// CONCATENATED MODULE: ./app/(root)/search/page.tsx
...
async function Page() {
    ...
    // FETCH USERS
    const result = await (0,user_actions.fetchUsers)({
        userId: user.id,
        searchString: "",
        pageNumber: 1,
        pageSize: 25
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("section", {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: result.users.length === 0 ? /*#__PURE__*/ jsx_runtime_.jsx("p", {
                    className: "no-result",
                    children: " No users"
                }) : /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                    children: result.users.map((user)=>/*#__PURE__*/ jsx_runtime_.jsx(UserCard, {
                            id: user.id,
                            name: user.name,
...
var __webpack_exports__ = __webpack_require__.X(0, [3342,4813,4205,3997,2961,8422,2451,5156,9841,1900,7297,1971,9221,8633,9532,8776,2857,4368,1787], () => (__webpack_exec__(4731)));
