...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 65563)), "C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\activity\\page.tsx"],
...
const pages = ["C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\activity\\page.tsx"];
...
/* harmony import */ var _lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18776);
...
const Page = async ()=>{
    ...
    const userInfo = await (0,_lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_2__.fetchUser)(user.id);
    if (!userInfo?.onboarded) (0,next_navigation__WEBPACK_IMPORTED_MODULE_1__.redirect)("/onboarding");
    // getActivity
    const activity = await (0,_lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_2__.getActivity)(userInfo._id);
    // FETCH USERS
    const result = await (0,_lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_2__.fetchUsers)({
        userId: user.id,
        searchString: "",
        pageNumber: 1,
        pageSize: 25
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("section", {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("section", {
                className: "mt-10 flex-col gap-5",
                children: activity.length > 0 ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    children: activity.map((activity)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                            href: `/thread/${activity.parentId}`,
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("article", {
                                className: "activity-card mb-3",
                                children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [3342,4813,4205,3997,2961,8422,2451,5156,9841,1900,9221,8633,9532,8776,1787], () => (__webpack_exec__(48968)));
