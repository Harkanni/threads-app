...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6457)), "C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\thread\\[id]\\page.tsx"],
...
const pages = ["C:\\Users\\Owner\\Desktop\\React Folder\\threads\\app\\(root)\\thread\\[id]\\page.tsx"];
...
/* harmony import */ var _components_ui_input__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5538);
...
const Comment = ({ threadId, currentUserImg, currentUserId })=>{
    ...
    const form = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_8__/* .useForm */ .cI)({
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_9__/* .zodResolver */ .F)(_lib_validations_thread__WEBPACK_IMPORTED_MODULE_5__/* .CommentValidation */ .g),
        defaultValues: {
            thread: ""
        }
    });
    const onSubmit = async (values)=>{
        await (0,_lib_actions_thread_actions__WEBPACK_IMPORTED_MODULE_7__/* .addCommentToThread */ .Ho)({
            threadId,
...
// EXTERNAL MODULE: ./components/cards/ThreadCard.tsx
var ThreadCard = __webpack_require__(52447);
// EXTERNAL MODULE: ./node_modules/next/dist/build/webpack/loaders/next-flight-loader/module-proxy.js
var module_proxy = __webpack_require__(61363);
;// CONCATENATED MODULE: ./components/forms/Comment.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\Owner\Desktop\React Folder\threads\components\forms\Comment.tsx`)
...
const Page = async ({ params })=>{
    ...
    const thread = await (0,thread_actions.fetchThreadsById)(params.id);
    // console.log(thread);
...
var __webpack_exports__ = __webpack_require__.X(0, [3342,4813,4205,3997,2961,8422,2451,5156,9841,1900,7297,3979,1971,6785,9221,8633,9532,8776,2857,4368,2447,1753,3605,6297], () => (__webpack_exec__(11210)));
